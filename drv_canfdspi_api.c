...
void DRV_CANFDSPI_MY_Configure(void)
{
...
int8_t DRV_CANFDSPI_TransmitChannelLoad(CAN_FIFO_CHANNEL channel, CAN_TX_MSGOBJ* txObj,
...
int8_t DRV_CANFDSPI_ReceiveMessageGet(CAN_FIFO_CHANNEL channel, CAN_RX_MSGOBJ* rxObj,
...
int8_t DRV_CANFDSPI_BusDiagnosticsGet(
...
int8_t DRV_CANFDSPI_BitTimeConfigure(
...
int8_t DRV_CANFDSPI_BitTimeConfigureNominal20MHz(
        CAN_BITTIME_SETUP bitTime)
{
    int8_t spiTransferError = 0;
    REG_CiNBTCFG ciNbtcfg;
...
int8_t DRV_CANFDSPI_BitTimeConfigureData20MHz(
        CAN_BITTIME_SETUP bitTime, CAN_SSP_MODE sspMode)
{
    int8_t spiTransferError = 0;
    REG_CiDBTCFG ciDbtcfg;
...
int8_t DRV_CANFDSPI_BitTimeConfigureNominal10MHz(
        CAN_BITTIME_SETUP bitTime)
{
    int8_t spiTransferError = 0;
    REG_CiNBTCFG ciNbtcfg;
...
int8_t DRV_CANFDSPI_BitTimeConfigureData10MHz(
        CAN_BITTIME_SETUP bitTime, CAN_SSP_MODE sspMode)
{
    int8_t spiTransferError = 0;
    REG_CiDBTCFG ciDbtcfg;
...
int8_t DRV_CANFDSPI_GpioDirectionConfigure(
...
int8_t DRV_CANFDSPI_GpioInterruptPinsOpenDrainConfigure(
...
int8_t DRV_CANFDSPI_GpioTransmitPinOpenDrainConfigure(
        GPIO_OPEN_DRAIN_MODE mode)
{
    int8_t spiTransferError = 0;
    uint16_t a = 0;
...
int8_t DRV_CANFDSPI_GpioPinSet(
...
int8_t DRV_CANFDSPI_GpioPinRead(
...
int8_t DRV_CANFDSPI_GpioClockOutputConfigure(
        GPIO_CLKO_MODE mode)
{
    int8_t spiTransferError = 0;
    uint16_t a = 0;
...
int8_t DRV_CANFDSPI_FifoIndexGet(
