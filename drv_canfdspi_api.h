...
int8_t DRV_CANFDSPI_WriteByteSafe( uint16_t address,
        uint8_t txd);
...
int8_t DRV_CANFDSPI_WriteWordSafe( uint16_t address,
        uint32_t txd);
...
int8_t DRV_CANFDSPI_BitTimeConfigure(CAN_BITTIME_SETUP bitTime, CAN_SSP_MODE sspMode,
